...
// Метод читает текст из файла и выдаёт текст.
    ...
    public static void main(String[] args) throws IOException {
        ...
        String addressOfOldFile = "src\\main\\java\\HomeWork\\Programming\\Practice4\\EnglishText.txt";

        // Адрес нового файла для копирования с использованием небуфферизированных потоков..
        String addressOfNotBufferedFile = "src\\main\\java\\HomeWork\\Programming\\Practice4\\FileNotBuffered.txt";

        // Адрес нового файла для копирования с использованием буфферизированных потоков..
        String addressOfBufferedFile = "src\\main\\java\\HomeWork\\Programming\\Practice4\\FileBuffered.txt";
