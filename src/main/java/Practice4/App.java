...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //String addressOfNewFileFull = "C:\\Users\\lapte\\IdeaProjects\\OracleAcademyMavenProject\\src\\main\\java\\Practice4\\NewTxtFile1.txt";
        //createFile(addressOfNewFileFull);
        //writeTextToFile(addressOfNewFileFull, "text1");

        // Адрес, где создаём файл.
        String addressOfNewFileRelative = "src\\main\\java\\Practice4\\NewTxtFile.txt";
