...
public class PropertiesFile {
    ...
    public static void main(String[] args) {
        ...
        try {
            properties.store(new FileOutputStream("C:\\Users\\lapte\\IdeaProjects\\OracleAcademyMavenProject\\src\\main\\java\\Practice4\\students_marks.properties"),"The marks of the students");
        } catch (IOException e) {
            e.printStackTrace();
        }
